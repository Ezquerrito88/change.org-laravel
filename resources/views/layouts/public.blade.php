...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
    <div class="container">
        ...
        <a class="navbar-brand navbar-brand-custom" href="#">change.org</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center">
                <a href="#" class="btn btn-outline-custom me-3">
                    Inicia una petición
                </a>
...
<main class="hero-section">
    ...
    <section class="bg-light-subtle py-5 text-center "> <h2 class="fw-bold">Usar la plataforma de peticiones n.º 1 del mundo es fácil</h2>
        <div class="container my-5">
            ...
            <div class="row text-center d-flex justify-content-center mt-5 ">
                <div class="accordion accordion-flush accordion-max-width" id="accordionGuias">
                    <div class="accordion-item ">
                        <h2 class="accordion-header" id="headingGuias">
                            <button class="accordion-button collapsed text-blue bg-light-subtle text-18px"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseGuias"
                                    aria-expanded="false" aria-controls="collapseGuias">
                                Lee nuestros consejos y guías sobre cómo crear una petición
                            </button>
                        </h2>
                        <div id="collapseGuias" class="accordion-collapse collapse "
                             aria-labelledby="headingGuias" data-bs-parent="#accordionGuias">
    ...
    <section class="container mt-5">
        ...
        <div class="d-flex flex-wrap justify-content-start">
            ...
            <a href="#" class="btn btn-outline-custom-blue text-18px my-1 d-flex align-items-center">
                Justicia Económica
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right ms-2" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                </svg>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-4">
            ...
            <a href="signPetition.html" class="text-decoration-none">
                <div class="col">
                    <div class="card shadow p-0 h-100">
                        <img src="https://assets.change.org/photos/8/eh/jj/XZehjjclUZeHmQa-800x450-noPad.jpg?1759927897" class="card-img-top border-bottom object-fit-cover" alt="Ley acoso escolar">
                        <div class="card-body">
            ...
            <a href="signPetition.html" class="text-decoration-none">
                <div class="col">
                    <div class="card shadow p-0 h-100">
                        <img src="https://assets.change.org/photos/9/nn/si/ArnnsibjtqWOsuJ-800x450-noPad.jpg?1758190667" class="card-img-top border-bottom object-fit-cover" alt="Ley acoso escolar">
                        <div class="card-body">
                            <h5 class="card-title text-clamp fw-bold">Me han echado de clase por llevar Hiyab. ¡Libertad religiosa YA en instituto IES Sagasta!</h5>
                            <p class="card-text text-blue mt-3">
                                <span class="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16"><path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/></svg></span>
                                259.830 firmas</p>
                        </div>
            ...
            <a href="signPetition.html" class="text-decoration-none">
                <div class="col">
                    <div class="card shadow p-0 h-100">
                        <img src="https://assets.change.org/photos/6/zy/tu/XvzyTUYFsYcnqzV-800x450-noPad.jpg?1758742974" class="card-img-top border-bottom object-fit-cover" alt="Ley acoso escolar">
                        <div class="card-body">
        ...
        <div class=" rounded d-flex flex-column flex-lg-row align-items-center bg-light">
            ...
            <div class="col-12 col-lg-6 p-3 p-lg-5 text-center text-lg-start">
                ...
                <p class="text-secondary mb-4">
                    TuCausa.org es una organización independiente, financiada únicamente
                    por millones de usuarios como tú. Colabora para proteger
            ...
            <div class="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-end pt-4 pt-lg-0">
                <img
                    src="https://static.change.org/homepageV3/homepage-sunrise-contribute@1x.png"
