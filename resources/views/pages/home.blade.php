        ...
        <section class="g pt-2 text-center container background-image d-none d-xxl-block">
            <div class="row g-2 justify-content-center align-items-start mt-5">
                ...
                <div class="col-2 d-flex justify-content-start p-2 position-relative">
                    <img class="img-fluid rounded-circle round-img position-relative z-0 custom-shadow"
                         src="https://static.change.org/homepageV3/img/changeorg_cuantovaleunavida_entregafirmas5.jpg"
                         alt="Imagen de petición izquierda">
                ...
                <div class="col-3 d-flex justify-content-start p-2 position-relative">
                    <img class="img-fluid rounded-circle round-img position-relative z-0 custom-shadow"
                         src="https://static.change.org/homepageV3/img/soloelpueblosalvaalpueblo5.JPG"
                         alt="Imagen de petición derecha">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-4">
                <div class="col">
                    <div class="card shadow p-0 h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-clamp fw-bold">Mi hija se suicidó... ¡LEY ACOSO ESCOLAR YA!</h5>
